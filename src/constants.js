...
export const password = String(process.env.PASSWORD) || "root123";
export const database = String(process.env.DATABASE_NAME) || "ChatAppDb";
...
export const APP_URL = '/api/v1/users'